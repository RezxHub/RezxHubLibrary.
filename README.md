...
function createToggle(option, parent)
	...
	function option:SetState(state)
		...
		tweenService:Create(tickboxInner, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {ImageColor3 = state and Color3.fromRGB(85, 130, 255) or Color3.fromRGB(20, 20, 20)}):Play()
		if state then
...
local function createBox(option, parent)
	...
	inputvalue.Focused:connect(function()
		focused = true
		tweenService:Create(outline, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {ImageColor3 = Color3.fromRGB(85, 130, 255)}):Play()
	end)
